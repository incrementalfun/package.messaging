...
namespace Incremental.Common.Queues.Message.Contract
{
    ...
    public interface IMessageBus
    {
        ...
        /// <returns></returns>
        Task Send<TMessage>(string queue, TMessage message, CancellationToken cancellationToken = default) where TMessage : Messages.Message;
        ...
        /// <typeparam name="TMessage"></typeparam>
        /// <returns></returns>
        Task Send<TMessage>(string queue, IEnumerable<TMessage> messages, CancellationToken cancellationToken = default)
